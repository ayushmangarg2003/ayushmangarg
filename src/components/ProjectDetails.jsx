...
const projectDetails = [
    {
        ...
        text: "A project utilizing ReactJs and its component library, Chakra UI, was developed with an API-based approach. It enables users to track the real-time pricing of various cryptocurrencies.",
    ...
    {
        name: "MeTube",
        text: "I have created a video playing application in order to improve my skills in ReactJs and gain knowledge of its component library, ChakraUI.",
    ...
    {
        name: "TechGuy",
        text: "I have created a responsive homepage using ReactJs and SCSS to gain proficiency in both technologies and improve my development skills.",
        tags: ["SCSS", "ReactJs"],
        imgsrc: TechGuy,
    ...
    //     text: "This is the design of a doctor appointment website, developed using HTML, CSS, and Javascript. The backend of the sign-up/login page is made using Firebase, ensuring secure and efficient management of user information.",
    ...
    //     text: "It is a website that presents users with a list of dishes that can be prepared, along with their associated recipes and YouTube tutorials, by utilizing an API to retrieve information based on the ingredient input by the user.",
    //     tags: ["HTML", "CSS" , "JavaScript", "API"],
    //     imgsrc: FoodRecipe,
    ...
    // {
    //     name: "Binary Brains",
    //     text: "This was a project that I created during my first hackathon. It was an online event and our team was ranked 5th.",
    ...
    //     text: "This is a single page website that I developed to improve my CSS skills. Through its creation, I have gained knowledge of new concepts such as the parallax effect.",
    //     tags: ["HTML", "CSS" , "JavaScript"],
    //     imgsrc: Karobar,
    //     link: "https://ayushmangarg2003.github.io/karobarwebsite/",
    // },
    // {
    //     name: "Pocket Mart",
    //     text: "PocketMart is a multipage website that I created to enhance my proficiency in CSS, and through its development, I have gained knowledge of many new techniques.",
    //     tags: ["HTML", "CSS" , "JavaScript"],
    //     imgsrc: PocketMart,
    ...
    // {
    //     name: "Rapido Clone",
    //     text: "I have developed a clone of Rapido's website as a means to improve my CSS styling skills and gain proficiency in creating responsive designs.",
    //     tags: ["HTML", "CSS"],
    //     imgsrc: RapidoClone,
